	...
	<div class="container">
		...
		<div class="col-lg-1"></div>
           ...
           <div class = "panel-heading">
              <h2 style="margin-left: 20px; color: ;" class="panel-title title">Student Details</h2><br>
           </div><br>

           <div class="panel-body">
						<form method="post" action="student_action.php" class="form-horizontal" role="form" enctype="multipart/form-data"> 
			...
			<div class="form-group"> 
				...
				<div class="col-sm-6"> 
					<input type="var" class="form-control" name="year" placeholder="Enter Year"required> 
				</div> 
			</div> 
			...
			<div class="form-group"> 
				...
				<div class="col-sm-6"> 
					<input type="number" class="form-control" name="mobile_no" placeholder="Enter Mob No" > 
				</div> 
			</div> 

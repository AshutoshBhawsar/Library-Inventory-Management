...
<HEAD>
    <TITLE>Library->Student Listing</TITLE>
    <meta charset="utf-8">
                ...
                <div class="col-lg-10">
                    <div class = "panel panel-success">
                       <div class = "panel-heading">
                          <h2 style="margin-left: 20px; color: ;" class="panel-title title">Student Listing</h2><br>
                       </div><br>
                                ...
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <tbody>
                                           ...
                                           <tr class="odd gradeX">
                                                ...
                                                <td><img src="Stud_img/<?php echo $row['image_name'] ?>" width="100" height="80"></td>
                                                <td>
                                                <?php echo "<a href=student_listing_edit.php?roll_no=$roll_no style='color: lime; font-weight:bold;'>Edit";?>&nbsp;&nbsp;
                                                <?php echo "<a href=student_delete.php?roll_no=$roll_no style='color: red; font-weight:bold;'>Delete";?>
                                                </td>

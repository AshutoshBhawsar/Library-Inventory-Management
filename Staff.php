    ...
    <div class="col-lg-1"></div>
      ...
      <div class="panel-danger">
           <div class = "panel-heading">
              <h2 style="margin-left: 20px; color: ;" class="panel-title title">Staff Details</h2><br>
           </div><br>

           <div class="panel-body">
			
				<form method="post" action="staff_action.php" class="form-horizontal" role="form"  enctype="multipart/form-data"> 
        ...
        <div class="col-sm-6"> 
          <input type="file" class="form-control"name="file" ></input>
			...
			<div class="form-group"> 
				...
				<div class="col-sm-6"> 
					<input type="number" class="form-control" name="MobNo" placeholder="Enter Mob No"> 
				</div> 
			</div> 
      ...
      <div class="form-group"> 
        ...
        <div class="col-sm-6"> 
          <input type="text" class="form-control" name="username" placeholder="Enter username You want"> 
        </div> 
      </div>
        ...
        <div class="col-sm-6"> 
          <input type="password" class="form-control" name="password" placeholder="Enter password"> 
			...
			<div class="col-sm-offset-2 col-sm-10"> 
				<button type="submit" name="submit" class="btn btn-outline btn-danger">Submit</button> 
			</div> 
			</div></form>
			</div>
	    <div class="col-lg-1"></div> 

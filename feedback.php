...
<HEAD>
  ...
  <script src="Lib_Assets/bootstrap-hover-dropdown.js"></script>
   <script src="Lib_Assets/metisMenu.min.css"></script>
	...
	.title
      {
      	margin-left: 10px;
        font-size: 40;
	    text-shadow: 1px 3px 3px skyblue;
			...
			<div class="container">
				<div class="row">
					<div class="col-lg-8">
					 <div class = "panel panel-info">
		              ...
		              <div class="panel-body">
						<form method="post" action="feedback_action.php" class="form-horizontal" role="form"> 
					...
					<div class="form-group"> 
						...
						<div class="col-sm-6"> 
							<input type="email" class="form-control" name="emailid" placeholder="Enter E-mail id"required> 
						</div> 
					</div> 

	...
	<div class="container">
		...
		<div class="col-lg-"></div>
           ...
           <div class="panel-body">
				<form method="post" action="f-suggession_action.php" class="form-horizontal" role="form"> 
			...
			<div class="col-sm-offset-2 col-sm-10"> 
				<button type="submit" name="submit" class="btn btn-outline btn-info">Submit</button> 
			</div> 
			</div></form>
			</div><!-- panel body -->
			</div><!-- panel -->
			...
			<div class="col-lg-3">
              <h4><ul type="square"> <li><p class="text-danger text-left">Book Suggession form is <br><br>specially design for to mention<br> <br>the names of books not <br><br>available within Library.</p></li></ul></h4> 

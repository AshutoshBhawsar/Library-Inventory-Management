...
<HEAD>
    <TITLE>Library->Faculty Listing</TITLE>
    <meta charset="utf-8">
                ...
                <div class="col-lg-10">
                    <div class = "panel panel-danger">
                       <div class = "panel-heading">
                          <h2 style="margin-left: 20px; color: ;" class="panel-title title">Faculty Listing</h2><br>
                       </div><br>
                       ...
                       <div class="panel-body">
                            ...
                            <div class="dataTable_wrapper">
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    $result=mysql_query("SELECT * FROM faculty_table");
                                    ...
                                    <tbody>
                                           ...
                                           <tr class="odd gradeX">
                                                ...
                                                <td><img src="Pics/<?php echo $row['image_name'] ?>" width="100" height="80"></td>
                                                <td>
                                                <?php echo "<a href=faculty_listing_edit.php?id=$id style='color: aqua; font-weight:bold;'>Edit";?>&nbsp;&nbsp;
                                                <?php echo "<a href=faculty_delete.php?id=$id style='color: red; font-weight:bold;'>Delete";?>
                                                </td>
                                            </tr>
